...
def delete_project(
    ...
    try:
        ...
        # Step 2: Delete project and ALL related data (FULL CASCADE)
        try:
            # Order matters: delete children before parents
            # Delete product_step (child of product)
            ...
            # Delete tasks
            session.execute(text("DELETE FROM task WHERE project_id = :pid"), {"pid": project_id})
            # Delete project
